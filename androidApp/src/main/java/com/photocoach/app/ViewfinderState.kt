...
data class ViewfinderUi(
    ...
    val lockState: com.photocoach.app.camera.CameraLockState = com.photocoach.app.camera.CameraLockState(),
    ...
    val staticResearch: Boolean = false,
    val researchRoundPreparing: Boolean = false,
